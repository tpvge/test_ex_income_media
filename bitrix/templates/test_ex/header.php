...
<head>
	...
	<script type="text/javascript" src="<?= CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH . '/js/jquery-1.8.2.min.js', true) ?>"></script>
	<script type="text/javascript" src="<?= CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH . '/js/functions.js', true) ?>"></script>
		...
		<div class="hd_header_area">
			<div class="hd_header">
				...
				<div class="nv_topnav">
					<? $APPLICATION->IncludeComponent(
						...
						array(
							...
							"MENU_THEME" => "site",
							"ROOT_MENU_TYPE" => "my_top_menu",
							"USE_EXT" => "N",
							"COMPONENT_TEMPLATE" => "horizontal_multilevel_new"
						),
						false
					); ?>
				</div>
				<!-- <div class="nv_topnav">
					 ...
					 <ul>
						<li><a href="" class="menu-img-fon"><span></span></a></li>
